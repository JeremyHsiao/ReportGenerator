...
namespace ExcelReportApplication
{
    ...
    class XMLConfig
    {
        ...
        private static String[] DefaultKeyValuePairList =
        {
            ...
            @"Sheetname_ReportList",                            @"ReportList",
            @"Sheetname_HeaderTemplate_Source",                 @"BeforeLine21",
            @"Sheetname_HeaderTemplate_Destination",            @"BeforeLine21",
            @"Sheetname_BugList",                               @"Bug",
            @"Sheetname_TestCaseList",                          @"TestCase",
            @"Sheetname_ReleaseNote",                           @"ReleaseNote",
            @"Sheetname_ImportToJira",                          @"ImportToJira",
            @"Sheetname_TestPlan",                              @"TestPlan",
            @"Sheetname_AssigneeList",                          @"AssigneeList",
            @"Sheetname_TCTemplate",                            @"TCResult",
            ...
            @"Report_C_Update_Test_Info_by_Template",           @"false",
            @"Report_C_Save_ImportToJira_CSV",                  @"false",
            @"Report_C_PreFilterReportByTCSummaryStatus",       @"Pass, Conditional Pass, Fail",          
            ...
            @"TCSummery_LinkIssue_FollowTemplateFormat",        @"true",
            @"TCSummery_LinkIssue_FontDefault",                 @"Gill Sans MT, 10, Black, Regular",
            @"TCSummery_LinkIssue_A_Issue",                     @"Gill Sans MT, 10, Red, Regular",
            @"TCSummery_LinkIssue_B_Issue",                     @"Gill Sans MT, 10, Red, Regular",
            @"TCSummery_LinkIssue_C_Issue",                     @"Gill Sans MT, 10, Red, Regular",
            @"TCSummery_LinkIssue_D_Issue",                     @"Gill Sans MT, 10, Red, Regular",
            @"TCSummery_LinkIssue_Waive_Issue",                 @"Gill Sans MT, 10, Black, Regular",
            @"TCSummery_LinkIssue_Closed_Issue",                @"Gill Sans MT, 10, Black, Strikeout",
            @"TCSummery_LinkIssueFilterStatusString",           @"Close (0)",

            @"TestReport_LinkIssue_FollowTemplateFormat",       @"true",
            @"TestReport_LinkIssue_FontDefault",                @"Gill Sans MT, 10, Black, Regular",
            @"TestReport_LinkIssue_A_Issue",                    @"Gill Sans MT, 10, Red, Regular",
            @"TestReport_LinkIssue_B_Issue",                    @"Gill Sans MT, 10, Red, Regular",
            @"TestReport_LinkIssue_C_Issue",                    @"Gill Sans MT, 10, Red, Regular",
            @"TestReport_LinkIssue_D_Issue",                    @"Gill Sans MT, 10, Red, Regular",
            @"TestReport_LinkIssue_Waive_Issue",                @"Gill Sans MT, 10, Black, Regular",
            @"TestReport_LinkIssue_Closed_Issue",               @"Gill Sans MT, 10, Black, Strikeout",
            @"TestReport_LinkIssueFilterStatusString",          @"Close (0)",
