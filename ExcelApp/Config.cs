...
namespace ExcelReportApplication
{
    ...
    class XMLConfig
    {
        private static String[] DefaultKeyValuePairList =
        {
            ...
            @"Report_C_Update_Report_Sheetname",        @"false",
            ...
            @"TestReport_FilterStatusString",           @"Close (0)",
            ...
            @"LinkIssue_report_A_Issue_Color",          @"Red",
            @"LinkIssue_report_B_Issue_Color",          @"Black",
            @"LinkIssue_report_C_Issue_Color",          @"Black",
            @"LinkIssue_report_D_Issue_Color",          @"Black",

            @"Keyword_report_Font",                     @"Calibri",
            @"Keyword_report_FontSize",                 @"10",
            @"Keyword_report_FontColor",                @"Black",
            @"Keyword_report_FontStyle",                @"Regular",
            @"Keyword_report_A_Issue_Color",            @"Red",
            @"Keyword_report_B_Issue_Color",            @"Black",
            @"Keyword_report_C_Issue_Color",            @"Black",
            @"Keyword_report_D_Issue_Color",            @"Black",
            @"Keyword_report_replace_conclusion",       @"false",
