...
namespace ExcelReportApplication
{
    ...
    class XMLConfig
    {
        ...
        private static String[] DefaultKeyValuePairList =
        {
            ...
            @"KeywordIssue_report_A_Issue_Color",       @"Red",
            @"KeywordIssue_report_B_Issue_Color",       @"Black",
            @"KeywordIssue_report_C_Issue_Color",       @"Black",
            @"KeywordIssue_report_D_Issue_Color",       @"Black",
            @"Keyword_report_replace_conclusion",       @"false",
            @"Keyword_report_Hide_Keyword_Result_Bug",  @"false",  
