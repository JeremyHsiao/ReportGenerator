...
namespace ExcelReportApplication
{
    ...
    class XMLConfig
    {
        ...
        private static String[] DefaultKeyValuePairList =
        {
            ...
            @"InputExcel_Sheetname_ReleaseNote",                @"ReleaseNote",
            @"InputExcel_Sheetname_ImportToJira",               @"ImportToJira",
            @"InputExcel_Sheetname_TestPlan",                   @"TestPlan",
            @"InputExcel_Sheetname_AssigneeList",               @"AssigneeList",
